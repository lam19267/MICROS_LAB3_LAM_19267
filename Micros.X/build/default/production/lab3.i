...
main:
 ...
 loop:
    ...
    btfss ((INTCON) and 07Fh), 2 ;Revisa si el timer0 esta en 1
...
config_reloj:
    ...
    bcf ((OSCCON) and 07Fh), 6 ;Se selecciona la configuración 010
    bsf ((OSCCON) and 07Fh), 5
    bcf ((OSCCON) and 07Fh), 4
    bsf ((OSCCON) and 07Fh), 0 ;se activa el oscilador
    return

config_tmr0:
    banksel TRISA ;se selecciona el banco en cual se va a trabajar
    bcf ((OPTION_REG) and 07Fh), 5
    bcf ((OPTION_REG) and 07Fh), 3 ;se setea el Prescaler
 ...
 reiniciar_tmr0:
    ...
    bcf ((INTCON) and 07Fh), 2 ; se apaga el ((INTCON) and 07Fh), 2
    return
